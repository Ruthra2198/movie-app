...
const Home = () => {
  ...
  useEffect(() => {
    ...
    let url = `https://api.themoviedb.org/3/movie/popular?page=${page}&api_key=7b5fd64bdc505f192a0caf6664fa4f8f`
    if (search) {
      url = `https://api.themoviedb.org/3/search/movie?query=${search}&api_key=7b5fd64bdc505f192a0caf6664fa4f8f`
    }
    fetch(url)
